                    ...
                    <View style={{ flex: 1, backgroundColor: BG }}>
                      <Stack ref={navigationRef} screenOptions={{ headerShown: false, animation: 'fade', contentStyle: { backgroundColor: BG } }}>
                        ...
                        <Stack.Protected guard={!!isAuthed && onboardingCompleted === true}>
                          ...
                          <Stack.Screen name="exam-sim" />
                          <Stack.Screen name="flashcards" />
                          <Stack.Screen name="flashcards-topic" />
                          <Stack.Screen name="explainer" />
                          <Stack.Screen name="explainer-topic" />
                          <Stack.Screen name="study-planner" />
                          <Stack.Screen name="voice-tutor" />
                          <Stack.Screen name="knowledge-graph" />
                          <Stack.Screen name="learning-vault" />
                          <Stack.Screen name="teach-back" />
